...
function DevTools:Init(Settings)
	...
	function Window:Maximise()
		...
		TweenService:Create(Main, TweenInfo.new(.1), { Size = UDim2.new(0, 600, 0, 350), Position = Main.Position + UDim2.new(0, 0, 0, math.ceil(475 / 2) - 22) }):Play()
	end
	...
	TweenService:Create(Main, TweenInfo.new(1.2, Enum.EasingStyle.Quint, Enum.EasingDirection.InOut), { Size = UDim2.new(0, 600, 0, 350) }):Play()
	task.wait(1.3)
